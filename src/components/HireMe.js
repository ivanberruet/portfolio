...
function HireMe() {
	return (
		...
		sm:right-0
		'>
			<div className='w-48 h-48 flex- items-center justify-center relative md:w-24 md:h-24 overflow-hidden'>
				<CircularText className={"fill-dark animate-spin-slow dark:fill-light"} />
				<Link href={"mailto:ivanberruet95@gmail.com"} className='flex items-center justify-center
