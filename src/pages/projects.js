		...
		<>
			...
			<main className='w-full mb-16 flex flex-col items-center justify-center'>
				<Layout className='p-16'>
					<AnimatedText text="Imagination Trumps Knowledge!" className='mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl'/>
					
					<div className='grid grid-cols-12 gap-32 2xl:gap-20 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
